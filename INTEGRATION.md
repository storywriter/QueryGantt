...
- Browser checks against the actual Release-built component and bundled vis-timeline 8.5.0: all 23 integrated checks passed with zero runtime errors.
